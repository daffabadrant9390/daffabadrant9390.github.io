...
export const projectsData: ProjectsData = [
  {
    ...
    description:
      'Nibh egestas sagittis suspendisse aenean. Vulputate amet suscipit vel sollicitudin turpis egesta.',
  ...
  },
  {
    ...
    description:
      'Nibh egestas sagittis suspendisse aenean. Vulputate amet suscipit vel sollicitudin turpis egestas. Orci maecenas sed morbi aliquet mi posuere nulla lorem.',
    imageUrl: '/assets/bg-project-4.jpg',
