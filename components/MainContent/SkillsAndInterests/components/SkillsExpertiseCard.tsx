...
const SkillsExpertiseCard = ({
  ...
  return (
    <div className="p-5 lg:p-6 rounded-lg bg-blue-750 hover:bg-blue-790 hover:shadow-xl transition-all duration-300 cursor-pointer">
      <div className="flex flex-col [&>*:not(:last-child)]:mb-3 [&>*:not(:last-child)]:lg:mb-4">
        ...
        <div className="w-full flex flex-col items-start text-left">
          <h4 className="text-headings-6 lg:text-headings-5 text-white mb-2 lg:mb-3">
            {title}
          </h4>
